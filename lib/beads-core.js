...
export const DEFAULT_BEADS = [
  ...
  bead('mist-blue-seed-2', '雾蓝米珠', '#AEBFCA', 2, '米珠', '蓝', '琉璃', 0.35, 0.55, 'cool', 0.2, 0.12, ['accent']),
  ...
  bead('moss-seed-2', '苔绿米珠', '#84957A', 2, '米珠', '绿', '琉璃', 0.25, 0.48, 'neutral', 0.24, 0.14, ['accent']),

  bead('silver-seed-2', '雾银米珠', '#C5CDD1', 2, '米珠', '灰/黑', '金属', 0, 0.92, 'cool', 0.05, 0.16, ['accent']),
  ...
  bead('black-stone-6', '墨黑曜石', '#252A31', 6, '圆珠', '灰/黑', '天然石', 0.02, 0.7, 'cool', 0.08, 0.76, ['main', 'secondary', 'focal']),

  bead('gold-seed-2', '香槟金米珠', '#D7C08B', 2, '米珠', '金/黄', '金属', 0, 0.9, 'warm', 0.3, 0.16, ['accent']),
