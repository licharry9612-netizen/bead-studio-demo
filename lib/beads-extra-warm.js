...
export default [
  ...
  b('x-blush-seed', '柔粉米珠', '#E4C3C4', 2, '米珠', '粉/红', '琉璃', .28, .58, 'warm', .24, .1, ['accent'], 190),
  ...
  b('x-lilac-seed', '浅紫米珠', '#CFC0DA', 2, '米珠', '紫', '琉璃', .34, .6, 'cool', .22, .1, ['accent'], 185),
  ...
  b('x-rose-gold-seed', '玫瑰金米珠', '#C99486', 2, '米珠', '粉/红', '金属', 0, .88, 'warm', .28, .15, ['accent'], 170),
  b('x-gunmetal-seed', '枪灰米珠', '#666B6D', 2, '米珠', '灰/黑', '金属', 0, .75, 'cool', .04, .2, ['accent'], 160)
];
