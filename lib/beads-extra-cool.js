...
export default [
  b('x-white-seed', '瓷白米珠', '#F2F0EA', 2, '米珠', '白/米', '琉璃', .08, .55, 'neutral', .06, .12, ['accent', 'spacer'], 220),
  ...
  b('x-sky-seed', '天青米珠', '#B9D4E0', 2, '米珠', '蓝', '琉璃', .42, .62, 'cool', .2, .12, ['accent', 'spacer'], 210),
  ...
  b('x-mint-seed', '薄荷绿米珠', '#BFD8C2', 2, '米珠', '绿', '琉璃', .35, .6, 'cool', .17, .1, ['accent', 'spacer'], 200),
